...
$fields = [
  ...
  // CTA link text width
  acf_text([
    'label' => 'CTA Link Text Width',
    'name' => 'highlight-block__link-text-width',
    'key' => 'field_highlight-block_link-text-width',
    'instructions' => 'Enter the desired width, as a percentage of the block width (e.g., 75%). If left empty, the value will default to ‘auto’.',
    'required' => 0,
    'wrapper' => array(
      'width' => '33',
    ),
